...
import HeroSectionContentMoreSub from '../components/heroSectionContentMoreSub';
        ...
        <div className="content">
            <div className='background_image_container'>
                <div className='div_background_image'>
                    <img className='background_image' src='/img/Galaxie-Elliptique.jpg' alt='background' />
                    <Header handleLogout={handleLogout} />
                    <HeroSectionContentMoreSub />
                </div>
            </div>
            <main className='contentMoreMain'>
                <section className='sectionContentMore2 max_width1440'>
                    <h2>Qu'est ce qu'une galaxie elliptiques ?</h2>
                    <p>
